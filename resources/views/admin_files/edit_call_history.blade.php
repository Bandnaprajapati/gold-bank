											...
											<div class="row">
												...
												<div class="col-md-6">
													<div class="form-group row">
														...
														<div class="col-sm-8">
															<input type="time" name="time" class="form-control"value="{{ $result->time }}" />
														</div>
													</div>
												</div>
											</div>
											<div class="row">
												<div class="col-md-6">
													<div class="form-group row">
														...
														<div class="col-sm-8">
														 <input type="text" name="telecaller_name" class="form-control"value="{{ $result->telecaller_name }}" />
														</div>
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group row">
														...
														<div class="col-sm-8">
															<input type="text" name="contact_name" class="form-control"value="{{ $result->contact_name }}"  />
														</div>
													</div>
												</div>
											</div>

              ...
              <div class="col-md-12 grid-margin stretch-card">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="form-sample" action="{{ url('assingdata_update') }}" method="post">
                      @csrf
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                    <input type="text" name="start_id" class="form-control" value="{{ $result->start_id }}" />
                            ...
                            <div class="col-sm-3">
                              <input type="text" name="end_id" class="form-control" value="{{ $result->end_id }}" />
                            </div>
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                     <input type="text" name="employee_name" class="form-control" value="{{ $result->employee_name }}" />
                            </div>
                          </div>
                        </div>
                      </div>

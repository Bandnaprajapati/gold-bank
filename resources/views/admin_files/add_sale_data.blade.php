              ...
              <div class="col-md-12 grid-margin stretch-card">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="form-sample" action="{{ url('sale_store') }}" method="post">
                      @csrf
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" name="buyer_name" class="form-control" value="" />
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" name="buyer_contact" class="form-control" value="" />
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Buyer Address</label>
                             <div class="col-sm-9">
                              <input type="text" name="buyer_address" class="form-control" value="" />
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row margin">
                        ...
                        <input type="text" name="book_amount" class="form-control" id="book_amt" placeholder="Booking amount" o>

                        </div>
                        <div class="form-group mb-3 col-sm-3">
                        <label >Total EMI</label>
                        <input type="text" name="emi_count" class="form-control" id="emi_count" placeholder="Total EMI" value="">

                        </div>
                        <div class="form-group mb-3 col-sm-3">
                        <label>Rate of Interest</label>
                        <input type="text" name="rate_of_interest" class="form-control" id="roi" placeholder="Rate of interest">

                        </div>
                        <div class="form-group mb-3 col-sm-3">
                        <label>EMI Amount</label>
                        <input type="text" name="emi_amount" class="form-control" id="emi_amt" placeholder="EMI amount" value="">

          ...
          <div class="content-wrapper">
            <div class="page-header">
              ...
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="add_mortgage">Mortgage Deatail</a></li>
              ...
              <div class="col-md-12 grid-margin stretch-card">                     
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="form-sample" action="{{ url('mortgage_update') }}" method="post">
                      @csrf
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" name="customer_name"Customer class="form-control" value="{{ $result->customer_name }}" />
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" name="customer_contact" class="form-control" value="{{ $result->customer_contact }}" />
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Customer Address</label>
                             <div class="col-sm-9">
                              <input type="text" name="customer_address" class="form-control" value="{{ $result->customer_address }}" />
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div class="col-md-6">
                         ...
                         <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" name="rate_of_interest" class="form-control" value="{{ $result->rate_of_interest }}" />
                            </div>
                          </div>
                        </div>
                      </div> 
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" name="tolal_emi"class="form-control" value="{{ $result->tolal_emi }}" />
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" name="monthly_emi" class="form-control" value="{{ $result->monthly_emi }}" />
                            </div>
                          </div>
                        </div>
                      </div> 
